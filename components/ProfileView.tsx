    ...
    <div className="p-6 md:p-12 max-w-7xl mx-auto pb-40 relative">
      ...
      <div className="bg-[#0A0A0A] border border-white/5 p-6 md:p-10 mb-8 flex flex-col md:flex-row items-center gap-6 md:gap-12 relative overflow-hidden z-10">
        ...
        <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-black sol-gradient-text italic leading-none mb-4 uppercase">Solana_Sage</h1>
        </div>
      </div>
      ...
      <div className="bg-[#0A0A0A] border border-white/5 overflow-hidden relative z-10">
        <div className="p-6 md:p-8 border-b border-white/5">
            <h2 className="text-3xl md:text-5xl font-black italic uppercase tracking-tighter">History</h2>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full min-w-[700px]">
              <tbody className="divide-y divide-white/5">
                  <tr className="hover:bg-white/5 transition-colors group">
                      <td className="px-6 md:px-10 py-6 font-black uppercase text-[#00FFA3] text-sm">Genesis Pool #224</td>
                      <td className="px-6 md:px-10 py-6 text-center font-black italic text-zinc-300">#04</td>
                      <td className="px-6 md:px-10 py-6 text-right font-black italic text-[#00FFA3] text-lg">+2.50 SOL</td>
                  </tr>
              </tbody>
          </table>
        </div>
...
const ProfileStatCard: React.FC<{ icon: string, label: string, value: string, unit?: string, suffix?: string }> = ({ icon, label, value, unit, suffix }) => (
    <div className="bg-[#0A0A0A] border border-white/5 p-4 md:p-8 flex flex-col items-start overflow-hidden backdrop-blur-md">
