            ...
            <div className="space-y-2">
              {drafts.map((d, i) => {
                ...
                return (
                  <div
                    key={d.id}
                    className="group flex items-center gap-3 rounded-xl bg-white/[0.04] border border-white/5 hover:border-[#38BDF8]/30 hover:bg-[#38BDF8]/5 transition-all px-3 py-2.5"
                  >
                    <button
                      onClick={() => onRestore(d)}
